...
const en = {
  ...
  cliTrustTitle: "Time-limited external AI CLI full trust",
  ...
  cliTrustActiveUntil: "Full trust active until {time}",
  cliTrustHint: "Skips command and remote-copy prompts for this server until expiry. Secret changes and tunnels still require confirmation. Hard blocks remain, but they are not a sandbox.",
  cliTrustIndicator: "CLI full trust · {remaining} remaining",
  cliTrustIndicatorAction: "Click to revoke trust for this server.",
  cliTrustRevoked: "CLI full trust revoked",
...
const zhCN: Record<LangKey, string> = {
  ...
  cliTrustTitle: "限时完全信任外部 AI CLI",
  cliTrustOff: "正常审批",
  cliTrustOneHour: "信任 1 小时",
  cliTrustFourHours: "信任 4 小时",
  cliTrustEightHours: "信任 8 小时",
  cliTrustDay: "信任 24 小时",
  cliTrustActiveUntil: "完全信任生效至 {time}",
  cliTrustHint: "到期前跳过此服务器的命令和远程复制审批；secret 变更与隧道仍需确认。硬拦截继续生效，但它不是沙箱。",
  cliTrustIndicator: "CLI 完全信任 · 剩余 {remaining}",
  cliTrustIndicatorAction: "点击立即撤销此服务器的信任。",
  cliTrustRevoked: "已撤销 CLI 完全信任",
