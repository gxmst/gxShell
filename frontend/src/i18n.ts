...
const en = {
  ...
  updateCheckEnabledHint: "The only request gxShell makes on its own. Turn it off to stay fully offline.",
...
const zhCN: Record<LangKey, string> = {
  ...
  updateCheckEnabledHint: "这是 gxShell 唯一主动发起的网络请求。关闭后完全不联网。",
  updateCheckNow: "立即检查",
  updateChecking: "检查中…",
  updateCurrent: "当前版本",
