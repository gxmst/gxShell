...
- Each opted-in profile may receive time-limited automation trust (1/4/8/24 hours); there is no permanent trust switch. Trust auto-approves T1 scoped, recoverable commands and bounded local T2 operations; undecidable or external T2 commands still take a native click. T3 is an immediate individual native click and is never batched, regardless of trust. Remote-to-remote copy retains its separate rule that both endpoint profiles must be trusted.
