...
SECURITY:
  ...
  - Simple read-only commands run without a prompt; prompted commands include a short action explanation.
  - T1/T2 confirmations may be batched; every T3 command is confirmed separately.
